...
<aside class="main-sidebar">
	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			$master = ["jurusan", "bagian", "matkul", "dosen", "mahasiswa"];
			...
			<li class="<?=$page==='lowongan'?"active":""?>">
				<a href="<?=base_url('lowongan')?>" rel="noopener noreferrer">
					<i class="fa fa-file-text-o"></i> <span>Lowongan</span>
				</a>
			</li>
			<?php endif; ?>
