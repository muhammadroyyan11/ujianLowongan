<div class="box">
	...
	<div class="box-body">
		<div class="mt-2 mb-3">
			...
			<a href="<?= base_url('bagian/import') ?>" class="btn btn-sm btn-flat btn-success"><i class="fa fa-upload"></i> Import</a>
		...
		<table id="bagian" class="w-100 table table-striped table-bordered table-hover">
			<thead>
				<tr>
					<th>No.</th>
					<th>Bagian</th>
...
<div class="modal fade" id="myModal">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<?= form_open('bagian/add', array('id', 'tambah')); ?>
...
<script src="<?= base_url() ?>assets/dist/js/app/master/bagian/data.js"></script>